...
ANDROID_CMAKE_ARGS="-G Ninja -DANDROID_ABI=arm64-v8a ${ANDROID_TOOLCHAIN_ARG}"
MAC_CMAKE_ARGS="-DPLATFORM=MAC_ARM64 -DDEPLOYMENT_TARGET=13.3 ${IOS_TOOLCHAIN_ARG}"
...
if [ "$OS" = "Darwin" ]; then
    ...
    TOOLS_GENERATOR=${NINJA_GENERATOR}
else
