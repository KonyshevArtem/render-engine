        ...
        m_Samplers(std::move(samplers))
{
    ...
    CreatePSO(m_Shaders, m_BlendInfo, k_DefaultColorFormat, k_DefaultDepthFormat, s_DefaultVertexAttributes);
...
const GraphicsBackendProgram &ShaderPass::GetProgram(const VertexAttributes &vertexAttributes, TextureInternalFormat colorTargetFormat, TextureInternalFormat depthTargetFormat)
{
    ...
    return CreatePSO(m_Shaders, m_BlendInfo, colorTargetFormat, depthTargetFormat, vertexAttributes.GetAttributes());
}
